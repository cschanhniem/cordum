...
function emptyInputMatch(): GlobalPolicyInputMatch {
  return {
    tenants: [],
    topics: [],
    capabilities: [],
...
function emptyOutputMatch(): GlobalPolicyOutputMatch {
  return {
    tenants: [],
    topics: [],
    capabilities: [],
...
function emptyBudgetConstraints(): GlobalPolicyBudgetConstraints {
  return {};
}

function emptySandboxConstraints(): GlobalPolicySandboxConstraints {
  return {
    networkAllowlist: [],
    fsReadOnly: [],
    fsReadWrite: [],
...
function emptyToolchainConstraints(): GlobalPolicyToolchainConstraints {
  return {
    allowedTools: [],
    allowedCommands: [],
  };
...
function emptyDiffConstraints(): GlobalPolicyDiffConstraints {
  return {
    denyPathGlobs: [],
  };
}

function emptyConstraints(): GlobalPolicyConstraints {
  return {
    budgets: emptyBudgetConstraints(),
    sandbox: emptySandboxConstraints(),
    toolchain: emptyToolchainConstraints(),
    diff: emptyDiffConstraints(),
  };
}
