...
export const G_KEY_MAP: Record<string, string> = {
  ...
  a: "/agents",
  k: "/approvals",
  p: "/govern/overview?tab=input-rules",
  v: "/govern/overview?tab=velocity",
  e: "/govern/overview?tab=evaluation&mode=analytics",
  t: "/govern/overview?tab=scope",
  q: "/govern/quarantine",
  b: "/govern/overview?tab=bundles",
  x: "/packs",
  s: "/settings",
  d: "/dlq",
  l: "/audit",
...
const ROUTE_LABELS: Record<string, string> = {
  ...
  "/agents": "Agents",
  "/approvals": "Approvals",
  "/govern/overview?tab=input-rules": "Input Rules",
  "/govern/overview?tab=velocity": "Velocity Controls",
  "/govern/overview?tab=evaluation&mode=analytics": "Policy Evaluation",
  "/govern/overview?tab=scope": "Scope & Rollout",
  "/govern/quarantine": "Quarantine",
  "/govern/overview?tab=bundles": "Bundles",
  "/packs": "Packs",
  "/settings": "Settings",
  "/dlq": "Dead Letters",
  "/audit": "Audit Log",
