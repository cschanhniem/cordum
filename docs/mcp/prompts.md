...
- [Per-tool approval gates](./per-tool-approval.md) — how mutating
  tools fire approval workflows.
- [Outbound signing](./outbound-signing.md) — signed outbound MCP
  calls.
- [Scope filtering](./scope-filtering.md) — runtime tool filtering
  by agent identity.
