...
![CORDUM_API_KEY in the Cordum dashboard](../static/img/mcp-cursor/01-api-key.png)

If an image is missing, the screenshot has not yet been captured
on a live stack — see the human cold-test checklist.
...
![Cursor welcome screen](../static/img/mcp-cursor/02-welcome.png)
...
![Cursor MCP settings panel with cordum server listed](../static/img/mcp-cursor/03-mcp-settings.png)
...
![Cursor chat panel showing a cordum tool call result](../static/img/mcp-cursor/04-tool-call.png)
