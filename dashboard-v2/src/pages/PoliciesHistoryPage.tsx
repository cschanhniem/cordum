  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="Change log for policy rules"
        actions={
      ...
      <InstrumentCard>
        <InstrumentCardBody className="py-16">
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-sm font-semibold font-display text-foreground mb-1">Policy History</h3>
            <p className="text-xs text-muted-foreground max-w-md">
              Track all changes to policy rules over time with diff views.
            </p>
          </div>
        </InstrumentCardBody>
      </InstrumentCard>
