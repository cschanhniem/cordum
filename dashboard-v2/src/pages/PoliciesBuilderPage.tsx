...
export default function PoliciesBuilderPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Rule Builder"
        subtitle="Create or edit policy rules"
        actions={
      ...
      <InstrumentCard>
        <InstrumentCardBody className="py-16">
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-sm font-semibold font-display text-foreground mb-1">Rule Builder</h3>
            <p className="text-xs text-muted-foreground max-w-md">
              Build policy rules with conditions, decisions, and priority ordering.
            </p>
          </div>
        </InstrumentCardBody>
      </InstrumentCard>
