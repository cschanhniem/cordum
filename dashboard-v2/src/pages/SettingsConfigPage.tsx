      ...
      <InstrumentCard>
        <InstrumentCardBody className="py-16">
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-sm font-semibold font-display text-foreground mb-1">System Configuration</h3>
            <p className="text-xs text-muted-foreground max-w-md">
              Configure global settings including retention policies, rate limits, and feature flags.
            </p>
          </div>
        </InstrumentCardBody>
      </InstrumentCard>
