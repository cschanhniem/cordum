      ...
      <InstrumentCard>
        <InstrumentCardBody className="py-16">
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-sm font-semibold font-display text-foreground mb-1">Schemas</h3>
            <p className="text-xs text-muted-foreground max-w-md">
              Define and manage schemas for job contexts, results, and workflow data.
            </p>
          </div>
        </InstrumentCardBody>
      </InstrumentCard>
