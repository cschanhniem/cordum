      ...
      <InstrumentCard>
        <InstrumentCardBody className="py-16">
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-sm font-semibold font-display text-foreground mb-1">API Keys</h3>
            <p className="text-xs text-muted-foreground max-w-md">
              Create, rotate, and revoke API keys for programmatic access to the control plane.
            </p>
          </div>
        </InstrumentCardBody>
      </InstrumentCard>
